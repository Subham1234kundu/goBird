...
function PressReleaseContent() {
  ...
  const currentPressReleases = pressReleases.slice(
    startIndex,
    ...
    <div className="overflow-x-hidden">
      ...
      <div className="bg-custom-bg w-full h-[250px] sm:h-[300px] md:h-[510px] flex items-center justify-center px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-start max-sm:items-center justify-between gap-4 sm:gap-10 md:gap-10 lg:gap-12 w-full max-w-8xl">
          ...
          <h3 className="text-white max-sm:text-[14px] font-light text-sm sm:text-base md:text-lg lg:text-xl xl:text-[32px] w-full lg:w-[35%] leading-10 text-left  max-sm:leading-[22px]">
            Stay updated with the latest product launches, innovations, and
            milestones from Grobird
          </h3>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-between gap-6 sm:gap-8 md:gap-10 lg:gap-12 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-8 sm:py-10 md:py-12 lg:py-16 lg:pb-28 mx-auto max-w-8xl">
        <h2 className="text-[#000A1B] text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[64px] font-medium leading-tight w-full lg:w-[75%]">
          <span className="text-[#3B3B3D73]">Grobird Press Releases</span>{" "}
          <br /> & Product <br /> Announcements
        </h2>
        <h3 className="text-[#000A1B] text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[42px] lg:w-[25%] text-start lg:text-end mt-4 lg:mt-0">
          Our Stories
        </h3>
      </div>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-8 lg:py-0">
          <div className="text-white text-center lg:text-left mb-6 lg:mb-0">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-[42px] mb-2 leading-tight">
              {/* Empowering Startups and <br /> Enterprises Alike – Join Us */}
              Press & Speaking Inquiries
            </h2>
          </div>
          <div className="text-white text-center lg:text-right">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[24px] font-light mb-6 lg:mb-8 leading-relaxed">
              For media, analyst, or speaking <br /> requests, contact us at{" "}
              <a href="mailto:team@grobird.in?subject=Inquiry">
                team@grobird.in
              </a>
            </h3>
            <button
