  ...
  const mobileSlides = [
    {
      ...
      description: "We help businesses define IT strategies, assess systems, and create roadmaps for transformation.",
      list: ["IT Roadmaps & Strategy", "System Audits & Optimization", "Digital Transformation Guidance"],
    ...
    },
    {
      ...
      description: "From enterprise applications to consumer-facing apps, we build software that drives growth.",
      list: ["Web Application Development", "Mobile App Creation", "Enterprise Software Solutions"],
    ...
    },
    {
      ...
      description: "Secure, reliable, and scalable cloud solutions to power your digital operations.",
      list: ["Cloud Migration Strategy", "DevOps & Automation", "Cloud Security & Compliance"],
    ...
    },
    {
      ...
      description: "End-to-end product engineering services to bring your innovative ideas to life.",
      list: ["MVP Development", "Full-Cycle Engineering", "Product Modernization"],
        ...
        <div className="bg-custom-bg w-full h-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-18 pt-14 md:pt-18 lg:pt-30 relative">
          ...
          <div ref={headerContentRef} className="flex flex-col w-full max-w-[1400px] mx-auto relative z-10 pb-16">
            ...
            >
              ...
              <span className="sm:hidden block" style={{ fontFamily: 'Geist, var(--font-inter), sans-serif', fontSize: '42px', fontWeight: 200, marginTop: '3rem', lineHeight: '55px', letterSpacing: '0px' }}>
            ...
            >
              ...
              <span className="sm:hidden block" style={{ fontFamily: 'var(--font-montserrat)', fontSize: '14px', fontWeight: 400, lineHeight: '17px', marginTop: '1rem', opacity: 1, letterSpacing: '-0.01em' }}>
            ...
            >
              ...
              <div className="relative z-20 w-full flex flex-col items-center h-full">
                ...
                <div className="flex flex-col items-end text-right mb-8 w-full mt-8 px-6">
                  <h3 className="text-4xl font-light mb-6 text-white" style={{ fontFamily: 'Montserrat', fontWeight: 400 }}>
                    {slide.category}
                  </h3>
                  <button
                ...
                <div className="relative w-[310px] h-[481px] overflow-hidden shadow-2xl mt-40 bg-black/20 backdrop-blur-sm">
                  ...
                  <div className="absolute bottom-10 left-6 right-6 z-20">
                    <h4 className="text-3xl font-light mb-6 text-white leading-tight" style={{ fontFamily: 'Montserrat' }}>
                      {slide.title}
                    </h4>
                    <div className="flex flex-col gap-4 mt-4">
                      {slide.list.slice(0, 3).map((item, i) => (
                        <div key={i} className="flex items-start gap-3">
                          ...
                          <p className="text-lg font-light text-white/95 leading-snug" style={{ fontFamily: 'Inter' }}>{item}</p>
                        </div>
                      ))}
                    </div>
                  </div>
  ...
  `}</style>
    ...
    @media (max-width: 640px) {
      ...
      .serve-image-item::after {
        ...
        bottom: 0;
        top: 63.73%;
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, #010917 100%);
        pointer-events: none;
      }
  ...
  `}</style>
    ...
    @media (max-width: 640px) {
      ...
      [data-index="2"] {
        ...
        display: block !important;
        background: linear-gradient(157.32deg, #010917 14.74%, #006BCB 113.84%) !important;
      }
      /* Number 92% */
      ...
      [data-index="4"] {
        height: 288px !important;
        display: block !important;
        background: linear-gradient(134.37deg, #F95524 -5.97%, #010917 72.73%) !important;
      }
      /* Number 3X */
