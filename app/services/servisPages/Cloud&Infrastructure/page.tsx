    ...
    <div className="w-full overflow-x-hidden">
      ...
      <div className="bg-custom-bg w-full h-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-18 pt-14 md:pt-18 lg:pt-44 lg:pb-16 relative">
        ...
        <div className="flex absolute right-0 top-0 h-full">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #EDED4A 45%, #000A1B 100%)",
              opacity: 0.05,
            }}
          ></div>
          <div
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #EDED4A 50%, #000A1B 100%)",
              opacity: 0.62,
            }}
          ></div>
          <div
        ...
        >
          ...
          `}</style>
          <h1
            className="cloud-infra-title text-white text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-[82px] 2xl:text-7xl font-light leading-tight mb-8 lg:mb-12 w-full sm:w-[90%]"
            style={{ fontWeight: 300 }}
          >
            Secure Global Cloud and Data Infrastructure Businesses
          </h1>
          <h3 className="text-white font-light text-base sm:text-base md:text-md lg:text-md xl:text-[30px] 2xl:text-2xl w-full sm:w-[90%] md:w-[85%] lg:w-[75%] leading-[25px] sm:leading-10">
            Grobird designs, deploys, and operates cloud and data stacks with
            in‑country processing, data‑residency controls, and automated cost
            governance—so your teams innovate without overspend or violations.
          </h3>
      ...
      <WhyChooseSection
        ...
        items={[
          ...
          {
            text: "Data Residency and Compliance Platforms",
            highlighted: true,
          },
          {
            text: "LLM Traffic Governance and Monitoring",
            highlighted: false,
          },
          {
            text: "FinOps and SRE Reliability Optimization",
            highlighted: false,
          },
        ]}
      ...
      <StatisticsRow
        ...
        statistics={[
          ...
          },
          {
            ...
            suffix: "%",
            color: "text-[#FE4C00]",
            description: "Save costs, provision environments faster.",
          },
          {
            value: 5,
            suffix: "X",
          ...
          },
          {
            ...
            suffix: "%",
            color: "text-[#FE4C00]",
            description: "Audit logs provide cryptographic proof.",
          },
        ]}
      />
      ...
      <div
        ...
        className="w-full flex flex-col lg:flex-row items-center justify-center lg:justify-between min-h-[450px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[650px] xl:h-[700px] relative overflow-hidden"
        style={{ backgroundColor: "#FAFAFA" }}
      >
        {/* Bird Footer Image - Right Side */}
        <div
          ref={footerBirdRef}
          className="absolute right-0 inset-y-0 w-full opacity-30 sm:opacity-50 md:opacity-70 lg:opacity-100 sm:w-3/4 md:w-2/3 lg:w-1/2 h-full"
        >
          <Image
        ...
        <div
          ref={footerImageRef}
          className="w-full lg:w-[45%] xl:w-[40%] flex items-center justify-center py-6 sm:py-8 md:py-10 lg:py-0 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-0 relative z-10"
        >
        ...
        <div
          ...
          className="w-full lg:w-[55%] xl:w-[60%] flex flex-col items-center lg:items-start justify-center px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-6 sm:py-8 md:py-10 lg:py-8 relative z-10"
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium text-center lg:text-left mb-5 sm:mb-6 md:mb-7 lg:mb-8 leading-snug sm:leading-tight max-w-[90%] sm:max-w-full">
            Seamless, Secure, and <br className="hidden sm:block" />
            Scalable Cloud Tailored for <br className="hidden sm:block" /> Your
            Business
          </h2>
          <button
            onClick={() => router.push("/contact")}
            className="bg-[#FF662A] text-white px-6 sm:px-7 md:px-8 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-medium hover:opacity-90 transition-opacity"
          >
