  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="bg-custom-bg w-full h-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-18 pt-14 md:pt-18 lg:pt-42 lg:pb-16 relative">
        ...
        <div className="flex absolute right-0 top-0 h-full">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FFFFFF 40%, #000A1B 90%)",
              opacity: 0.05,
            }}
          ></div>
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FFFFFF 40%, #000A1B 85%)",
              opacity: 0.25,
            }}
          ></div>
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FFFFFF 40%, #000A1B 87%)",
              opacity: 0.4,
            }}
          ></div>
          <div
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FFFFFF 40%, #000A1B 95%)",
              opacity: 0.64,
            }}
          ></div>
          <div
        ...
        >
          ...
          `}</style>
          <h1
            className="it-consulting-title text-white text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-[82px] 2xl:text-7xl font-light leading-tight mb-8 lg:mb-12 w-full sm:w-[90%]"
            style={{ fontWeight: 300 }}
          >
            {/* IT <br className="block sm:hidden" /> Consulting */}
            Enterprise IT and <br /> AI Consulting
          </h1>
          <h3 className="text-white font-light text-base sm:text-base md:text-md lg:text-md xl:text-[30px] 2xl:text-2xl w-full sm:w-[90%] md:w-[85%] lg:w-[75%] leading-[25px] sm:leading-10">
            Grobird works with CIOs, CDOs, CISOs, and Heads of Product to
            redesign IT, AI, and data landscapes for security, compliance, and
            speed—without derailing existing operations.
          </h3>
      ...
      <WhyChooseSection
        ...
        subtitle="Frameworks and Operations"
        items={[
          {
          ...
          {
            text: "Governance-First AI Data Cloud Architecture",
            highlighted: true,
          },
          {
            text: "Pragmatic Platform Modernization Without Risk",
          },
          {
            text: "Executive-Ready Roadmaps and Risk Insights",
          },
        ]}
      ...
      <WeBuildSection
        ...
        description="Reduced audit findings, faster vendor and project approvals, and fewer AI‑related incidents through standardized controls and clearer ownership."
