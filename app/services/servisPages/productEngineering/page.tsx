    ...
    <div className="w-full overflow-x-hidden">
      ...
      <div className="bg-custom-bg w-full h-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-18 pt-14 md:pt-18 lg:pt-42 lg:pb-16 relative">
        ...
        <div className="flex absolute right-0 top-0 h-full">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FF662AA8 40%, #000A1B 90%)",
              opacity: 0.05,
            }}
          ></div>
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FF662AA8 40%, #000A1B 85%)",
              opacity: 0.25,
            }}
          ></div>
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FF662AA8 40%, #000A1B 87%)",
              opacity: 0.4,
            }}
          ></div>
          <div
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #FF662AA8 40%, #000A1B 95%)",
              opacity: 0.7,
            }}
          ></div>
          <div
        ...
        >
          ...
          `}</style>
          <h1
            className="product-engineering-title text-white text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-[82px] 2xl:text-7xl font-light leading-tight mb-8 lg:mb-12 w-full sm:w-[90%]"
          ...
          <h3 className="text-white font-light text-base sm:text-base md:text-md lg:text-md xl:text-[30px] 2xl:text-2xl w-full sm:w-[90%] md:w-[85%] lg:w-[75%] leading-[25px] sm:leading-10">
            {/* Grobird helps businesses turn concepts into fully engineered
            products from design and development to testing and deployment. */}
            From first line of code to Series B scale, Grobird architects,
            builds, and runs SaaS and platform products with secure multi‑tenant
            architectures, usage‑based billing, and analytics baked in.
          </h3>
      ...
      <WhyChooseSection
        ...
        items={[
          ...
          {
            text: "Investor-Ready Governed Architecture",
            highlighted: true,
          },
          {
            text: "User-Friendly Product Adoption Design",
            highlighted: false,
          },
          {
            text: "Scalable Delivery with CI/CD",
            highlighted: false,
          },
        ]}
      ...
      {/* We Build Section */}
      <WeBuildSection
        heading="Venture Studio Engagement"
        description="Grobird partners with founders on an equity‑plus‑fee model, providing MVP development, system architecture, product‑market fit validation, fundraising support, and governance setup for long‑term scale."
        ...
        statistics={[
          {
            ...
            suffix: "%",
            color: "text-[#000A1B]",
            description: "lower infrastructure costs through proactive FinOps.",
          },
          {
            value: 25,
            suffix: "%",
            color: "text-[#FE4C00]",
            description: "MVPs shipped in 8-12 weeks",
          },
          {
            value: 5,
            suffix: "X",
            color: "text-[#000A1B]",
            description: "reliability compared to early in‑house prototypes",
          },
          {
            value: 40,
            suffix: "%",
      ...
      <div
        ...
        className="w-full flex flex-col lg:flex-row items-center mt-10 sm:mt-16 lg:mt-20 mb-10 justify-between min-h-[400px] sm:min-h-[500px] lg:h-[600px]"
        style={{ backgroundColor: "#F5F9FE" }}
      >
        <div
          ref={customTextRef}
          className="flex flex-col gap-4 sm:gap-6 w-full lg:w-[40%] px-6 sm:px-10 md:px-16 lg:ml-2 py-8 lg:py-0"
        >
          ...
          <button
            onClick={() => router.push("/contact")}
            className="bg-black text-white rounded-full px-6 sm:px-8 py-2.5 sm:py-3 w-fit text-xs sm:text-sm font-medium hover:bg-gray-800 transition-colors"
          >
            Connect Now!
          </button>
        </div>
        <div
          ref={customImageRef}
          className="w-full lg:w-[60%] h-[300px] sm:h-[400px] lg:h-full relative"
        >
          <Image
