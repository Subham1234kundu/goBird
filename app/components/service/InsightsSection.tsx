  ...
  return (
    <div className="w-full bg-transparent">
      ...
      div::-webkit-scrollbar {
        ...
        @media (max-width: 639px) { /* Only run animation on mobile */
          ...
          @keyframes marquee {
            ...
            100% {
              ...
              transform: translateX(calc(-50% - 8px)); /* 8px accounts for half the 16px gap */
            }
          }
        }
    `}</style>
        ...
        {/* Scroll container */}
        <div className="flex gap-4 sm:gap-6 w-max sm:min-w-full sm:snap-x sm:snap-mandatory animate-marquee-mobile sm:animate-none">

          {/* Render the insights twice for an infinite loop effect on mobile */}
