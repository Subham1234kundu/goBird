...
const InsightsMore = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      {/* Header */}
      <div className="w-full flex items-start px-4 sm:px-6 md:px-10 xl:px-16 pt-8 sm:pt-12 xl:pt-44 pb-8 sm:pb-12 xl:pb-20" style={{ backgroundColor: '#000A1B' }}>
        <div className="max-w-7xl   ">
          <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[82px] font-light mb-4 xl:mb-14 w-full sm:w-[80%] lg:w-[100%]">
            The art of storytelling in <br /> branding and advertising
          </h1>
          <p className="text-white font-light text-sm sm:text-base lg:text-lg  mt-4 sm:mt-10 mb-5">Mar 1, 2025 • 8 min read</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-8 sm:py-12 xl:py-18">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
          ...
          <div className="w-full lg:w-[312px] h-auto lg:h-[378px] xl:mt-34 rounded-sm p-4 sm:p-6 flex-shrink-0" style={{ backgroundColor: '#006BCB' }}>
            <h3 className="text-white text-xl xl:text-[24px] font-medium mb-6">Follow us</h3>
          ...
          <div className="flex-1 text-[#000000] space-y-4 sm:space-y-6">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px] font-extralight mb-3 sm:mb-4 py-4">Introduction</h2>
              <p className="leading-relaxed xl:text-[24px] ">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px] font-extralight mb-4 sm:mb-8 py-4">The Hype</h2>
              <h3 className="font-bold text-base sm:text-lg xl:text-[24px] ">AI will replace human consultants</h3>
              <p className="leading-relaxed xl:text-[24px]">
            ...
            <div className="xl:mb-20">
              <h3 className="font-bold text-base sm:text-lg xl:text-[24px] ">One-size-fits-all AI solutions</h3>
              <p className="leading-relaxed xl:text-[24px] ">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px] mb-4 sm:mb-8 py-4 xl:pt-7">The Reality</h2>
              <h3 className="font-bold text-base sm:text-lg xl:text-[24px]">Enhanced decision-making</h3>
              <p className="leading-relaxed xl:text-[24px]">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg xl:text-[24px] ">Process automation</h3>
              <p className="leading-relaxed xl:text-[24px]">
            ...
            <div className="xl:mb-20">
              <h3 className="font-bold text-base sm:text-lg xl:text-[24px]">Smarter customer experiences</h3>
              <p className="leading-relaxed xl:text-[24px]">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px]  mb-4 sm:mb-8 py-4">The Balanced Approach</h2>
              <p className="leading-relaxed xl:text-[24px] ">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px]  mb-4 sm:mb-8 py-4">Final Takeaway</h2>
              <p className="leading-relaxed xl:text-[24px] ">
            ...
            <div className="mt-4 sm:mt-6 xl:mb-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 px-4 sm:px-5 md:px-7 lg:px-9 xl:px-12 py-6 sm:py-8">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px] font-extralight">All Insights</h2>
        <button
          onClick={() => router.push('/insights')}
          className="inline-flex items-center justify-center whitespace-nowrap rounded-xs text-sm xl:text-[16px] font-medium transition-colors h-10 px-4 py-2 text-white hover:opacity-90"
