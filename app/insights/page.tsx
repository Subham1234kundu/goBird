        ...
        <div className="w-full max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12">
            ...
            <div className="flex flex-col">
              ...
              />
              <h3 className="text-[#0B0B0B] text-sm sm:text-lg lg:text-[32px] mt-4 text-start w-[90%]">
              ...
              <div className="relative w-[90%] mt-2">
                <p className="text-[#0B0B0B] text-base cursor-pointer" onClick={() => setShowInsightsMore(true)}>Read more</p>
      ...
      <div className="w-full py-20 ">
        <div className="flex flex-col lg:flex-row items-stretch justify-between gap-0">
          <div className="flex flex-col justify-center items-start gap-8 lg:w-1/2 bg-[#F5F9FE] px-8 py-12 lg:px-12 lg:py-16">
            <h2 className="text-[#000A1B] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[64px] font-medium leading-tight">
